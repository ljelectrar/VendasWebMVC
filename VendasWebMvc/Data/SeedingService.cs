...
namespace VendasWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Chuck Norris", "chucknorris@gmail.com", new DateTime(1989, 11,2), 1000.0, d1);
            Seller s2 = new Seller(2, "Caio Castro", "caiocastro@gmail.com", new DateTime(1993, 12, 5), 1000.0, d2);
            Seller s3 = new Seller(3, "Leonardo di Caprio", "leonardodicaprio@gmail.com", new DateTime(1995, 4, 5), 1000.0, d1);
            Seller s4 = new Seller(4, "Brad Pitt", "bradpitt@gmail.com", new DateTime(1995, 4, 5), 1000.0, d3);
            Seller s5 = new Seller(5, "Johnny Depp", "johnnydepp@gmail.com", new DateTime(1995, 9, 31), 1000.0, d4);
            Seller s6 = new Seller(6, "Van Halen", "vanhalen@gmail.com", new DateTime(1991, 1, 1), 1000.0, d4);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2019, 10, 25), 11500.50, SaleStatus.Billed, s1);
